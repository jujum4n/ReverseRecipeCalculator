...
**
** Created: Thu Dec 3 00:43:47 2009
...
static const char qt_meta_stringdata_DialogImpl[] = {
    "DialogImpl\0\0addRec()\0clearFields()\0"
    "previewRec()\0doneClicked()\0"
};
...
void *DialogImpl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::addRecipe"))
        return static_cast< Ui::addRecipe*>(const_cast< DialogImpl*>(this));
